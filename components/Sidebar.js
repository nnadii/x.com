...
import ExploreIcon from "@/svgs/ExploreIcon.svg"
import { BellIcon, BookmarkIcon, ClipboardListIcon, UserIcon, DotsCircleHorizontalIcon, DotsHorizontalIcon } from "@heroicons/react/outline"
    ...
    return (
        <div className="hidden sm:flex flex-col items-center xl:items-start xl:w-[340px] p-2 fixed h-full">
            ...
            <div className="text-[#d9d9d9] flex items-center justify-center hoverAnimation xl:ml-auto xl:mr-5 mt-auto" onClick={signOut}>
                <img src={session.user.image} alt="img" className="h-10 w-10 rounded-full xl:mr-2.5" />
